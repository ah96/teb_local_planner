...
int main( int argc, char** argv )
{
		...
		*/
		...
		myfile1.open("./src/teb_local_planner/src/Data/cmd_vel.csv");
		...
		myfile2.open("./src/teb_local_planner/src/Data/local_plans.csv");		
		// Write columns' names to output files
		...
		myfile3.open("./src/teb_local_planner/src/Data/transformed_plan.csv");
		// Write columns' names to output files
		...
		for(int i = 0; i < int(local_costmap_data.size() / 160); i++)
		{
			...
			myfile2.open("./src/teb_local_planner/src/Data/local_plans.csv", std::ios::app);
			...
			if(i == 0)
			{
                myfile3.open("./src/teb_local_planner/src/Data/transformed_plan.csv", std::ios::app);
